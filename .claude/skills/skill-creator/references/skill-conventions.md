...
**Problem-first:** "I need to set up a project workspace" -- skill orchestrates the right tools. Users describe outcomes; the skill handles tools. Most of our skills use this approach.
...
|---------|----------|-------------|
| **Sequential workflow** | Multi-step processes in specific order | deploy-quiz |
| **Multi-MCP coordination** | Workflows spanning multiple services | scout (Reddit + X) |
...
With 32 skills enabled, keep SKILL.md sizes lean. Anthropic flags 20-50 simultaneous skills as the evaluation threshold. If a skill grows past ~300 lines, move detailed content to `references/` and link to it. Skills over 300 lines today: docx (482), scout-techniques (343), pdf (328), review-plan (305), quiz-smoke-test (304).
